        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                  Growth Plans for Future-Ready Teams
                </h1>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-5xl font-bold text-primary-400 mb-2">72%</div>
                <p className="text-gray-300">of workforce became cloud-certified within 6 months</p>
              </div>
              
              <div className="text-center">
                <div className="text-5xl font-bold text-primary-400 mb-2">40%</div>
                <p className="text-gray-300">increase in internal mobility (engineers moved to cloud and DevOps roles)</p>
              </div>
              
              <div className="text-center">
                <div className="text-5xl font-bold text-primary-400 mb-2">2x</div>
                <p className="text-gray-300">faster cloud project delivery with in-house teams</p>
              </div>
              
              <div className="text-center">
                <div className="text-5xl font-bold text-primary-400 mb-2">69</div>
                <p className="text-gray-300">Employee NPS improved from 38 to 69 in 6 months (confidence and career clarity)</p>
              </div>
            </div>
          </div>
