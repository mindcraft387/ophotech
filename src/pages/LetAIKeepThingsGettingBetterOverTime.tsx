        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                  Let AI Keep Things Getting Better Over Time
                </h1>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-5xl font-bold text-primary-400 mb-2">41%</div>
                <p className="text-gray-300">improvement in learner retention (measured across a 3-month cycle)</p>
              </div>
              
              <div className="text-center">
                <div className="text-5xl font-bold text-primary-400 mb-2">2x</div>
                <p className="text-gray-300">increase in course completion rates due to adaptive content sequencing</p>
              </div>
              
              <div className="text-center">
                <div className="text-5xl font-bold text-primary-400 mb-2">70%</div>
                <p className="text-gray-300">reduction in manual content curation and campaign optimization workload</p>
              </div>
              
              <div className="text-center">
                <div className="text-5xl font-bold text-primary-400 mb-2">100+</div>
                <p className="text-gray-300">micro-iterations per month, continuously improving platform performance</p>
              </div>
            </div>
          </div>
