...
const Hero: React.FC = () => {
  ...
  const slides: SlideData[] = [
    {
      id: 'strategic-impact',
      title: 'LICENSE LEVERAGING',
      titleParts: ['LICENSE', 'LEVERAGING'],
      blueWords: [1], // second word will be blue
      backgroundImage: 'https://images.pexels.com/photos/3184306/pexels-photo-3184306.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop',
      connectData: {
        title: 'Flywheel of Innovation',
        items: ['Flywheel of Innovation']
      },
      createData: {
        title: 'Transformation Partner',
        items: ['Transformation Partner']
      },
      evolveData: {
        title: 'Leadership Incubator',
        items: ['Leadership Incubator']
      }
    },
    {
      id: 'technology-scouting',
      title: 'Technology Scouting',
      titleParts: ['TECHNOLOGY', 'SCOUTING'],
      blueWords: [1], // second word will be blue
      ...
      connectData: {
        ...
        items: ['Emerging Tech Radar']
      },
      createData: {
        title: 'Create (Engineer)',
        items: ['Cross-Industry Solution Matching']
      },
      evolveData: {
        title: 'Evolve (Scale)',
        items: ['Collaborative Innovation with Experts']
      }
    },
    {
      id: 'capability-gaps',
      title: 'Capability Gaps',
      titleParts: ['CAPABILITY', 'GAPS'],
      blueWords: [1], // second word will be blue
      ...
      connectData: {
        title: 'Connect (Explore)',
        items: ['Team Skills vs Business Needs']
      },
      createData: {
        title: 'Create (Engineer)',
        items: [' Practical Tech Design Sessions']
      },
      evolveData: {
        title: 'Evolve (Scale)',
        items: ['Growth Plans for Future-Ready Teams']
      }
    },
    {
      id: 'enterprise-solutions',
      title: 'Enterprise Solutions',
      titleParts: ['ENTERPRISE', 'SOLUTIONS'],
      blueWords: [1], // second word will be blue
      backgroundImage: 'https://images.pexels.com/photos/1181675/pexels-photo-1181675.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop',
      connectData: {
        title: 'Connect (Explore)',
        items: ['Understand What the Business Really Needs']
      },
      createData: {
        title: 'Create (Engineer)',
        items: ['Test Fast with Real Use-Case Simulations']
      },
      evolveData: {
        title: 'Evolve (Scale)',
        items: ['Scale Smart with Automation and AI']
      }
    },
    {
      id: 'platform-integration',
      title: 'Platform Integration',
      titleParts: ['PLATFORM', 'INTEGRATION'],
      blueWords: [1], // second word will be blue
      backgroundImage: 'https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop',
      connectData: {
        title: 'Connect (Explore)',
        items: ['Connect Old Systems with New Tech']
      },
      createData: {
        title: 'Create (Engineer)',
        items: ['Build Flexible Systems That Talk to Each Other']
      },
      evolveData: {
        title: 'Evolve (Scale)',
        items: ['One Dashboard, Smarter Workflows']
      }
    },
    {
      id: 'feedback-loop',
      title: 'Feedback Loop',
      titleParts: ['FEEDBACK', 'LOOP'],
      blueWords: [1], // second word will be blue
      backgroundImage: 'https://images.pexels.com/photos/60504/security-protection-anti-virus-software-60504.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop',
      connectData: {
        title: '',
        items: ['Find What’s Broken and Why']
      },
      createData: {
        title: '',
        items: ['Fix Quickly, Improve Continuously']
      },
      evolveData: {
        title: '',
        items: ['Let AI Keep Things Getting Better Over Time']
      }
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-6 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center py-8 md:py-0">
              ...
              <div className="lg:col-span-8">
                {/* Main Title */}
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-8 md:mb-12 animate-fade-in-up animation-delay-400">
                ...
                {currentSlideData.id === 'strategic-impact' ? (
                  <div className="animate-fade-in-up animation-delay-600 mb-8">
                    ...
                    {/* Learn More Button - Positioned below and to the left */}
